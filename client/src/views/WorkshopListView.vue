...
const workshops = computed(() =>
  dbStore.workshops
    ...
    .sort((a, b) => new Date(a.anfang_datum_zeit) - new Date(b.anfang_datum_zeit)),
);
  ...
  <q-page class="page-shell">
    <div class="content-max">
      ...
      <div class="workshop-grid">
        <q-card v-for="workshop in gefilterteWorkshops" :key="workshop.id" class="glass-card workshop-card">
          ...
          <q-card-actions align="between">
            ...
            <div class="row q-gutter-xs items-center">
              ...
              <template v-if="dbStore.istOrganisator || dbStore.istAdmin">
                <q-btn dense flat round icon="edit" color="primary" @click="openEdit(workshop)" />
                <q-btn dense flat round icon="delete" color="negative" @click="deleteWorkshop(workshop)" />
              </template>
            </div>
          </q-card-actions>
        </q-card>
